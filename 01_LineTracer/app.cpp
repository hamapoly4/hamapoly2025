...
/* パラメータ (※PIDそれぞれのゲインは要調整) */
static const float      gPGAIN = 0.4;       // Pゲイン
static const float      gIGAIN = 0.01;      // Iゲイン
static const float      gDGAIN = 0.2;       // Dゲイン
static const int32_t    gTHREATHOLD = 31;   // しきい値
...
static const spikeapi::Motor            gLeftMotor(EPort::PORT_E, spikeapi::Motor::EDirection::COUNTERCLOCKWISE);    // 左モータ
static const spikeapi::Motor            gRightMotor(EPort::PORT_B, spikeapi::Motor::EDirection::CLOCKWISE);          // 右モータ
...
static void create_system()
{
    ...
    gLeftEdgeTracer     = new linetracer::LineTracer(gEachSignal[0], gEachSignal[1], gLeftLineTrace,
